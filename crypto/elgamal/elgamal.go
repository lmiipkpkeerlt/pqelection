...
// Returns an ElGamal public/private keypair.
func GenerateKeypair(prime *big.Int, generator *big.Int) (y *big.Int, x *big.Int) {
	random, err := rand.Int(rand.Reader, prime)
	if err != nil {
